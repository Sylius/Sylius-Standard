 ...
 */
final class Version20200403094840 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE sylius_product ADD color LONGTEXT NOT NULL COMMENT \'(DC2Type:product_color)\'');
    }
